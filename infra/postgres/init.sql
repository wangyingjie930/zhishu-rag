...
CREATE TABLE IF NOT EXISTS knowledge_bases (
  ...
  ingestion_policy jsonb NOT NULL DEFAULT '{"parser": "auto", "preprocessor": "default", "chunker": {"strategy": "semantic_hybrid", "language": "zh", "chunk_size": 900, "chunk_overlap": 120, "window_size": 2, "max_chunk_size": 1200, "semantic_buffer_size": 1, "semantic_threshold": 95}}',
  created_at timestamptz NOT NULL DEFAULT now()
);

ALTER TABLE knowledge_bases
  ADD COLUMN IF NOT EXISTS ingestion_policy jsonb NOT NULL DEFAULT '{"parser": "auto", "preprocessor": "default", "chunker": {"strategy": "semantic_hybrid", "language": "zh", "chunk_size": 900, "chunk_overlap": 120, "window_size": 2, "max_chunk_size": 1200, "semantic_buffer_size": 1, "semantic_threshold": 95}}';
